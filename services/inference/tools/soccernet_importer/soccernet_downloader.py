...
def download_soccernet_data(local_dir, tasks=["Spotting-v2"], leagues=["england_epl"]):
    ...
    print(
        " Check: https://github.com/SilvioGiancola/SoccerNetv2-DevKit#how-to-download-soccernet-v2"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dir", type=str, default="data/soccernet", help="Local directory for data"
    )
    parser.add_argument(
        "--tasks",
        nargs="+",
        default=["spotting"],
        help="Tasks to download (e.g. spotting, tracking, reid)",
    )
